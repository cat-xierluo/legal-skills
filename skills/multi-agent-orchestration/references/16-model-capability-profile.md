...
| **MiniMax**（稀宇科技） | L1–L2 | 多模态视觉理解突出；Code 变体代码能力扎实；语音/视频周边生态全 | 纯文本长链推理相对推理特化家族略保守；型号分支多需按任务选对变体 | 截图/扫描件理解、代码生成与审查、图文混合报告 | 按量计费时的极轻量批量任务（性价比不如轻量家族；**已购 token plan 是例外**——包月窗口用满即赚，轻量批量恰是消耗额度的合理用途） | 直连 API / 平台订阅 |
