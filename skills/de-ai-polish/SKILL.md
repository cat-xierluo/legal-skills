...
2. **频次红线**：以下词/结构在全文出现超**2次**即视为AI程式化：`越来越`/`越...越...`、`其实`、`往往`/`通常`/`很多时候`、`经常`/`常常`、`更重要的是`/`更麻烦的是`、`看起来`/`看来`、`真正`、`不只`/`不只是`、`更像`/`更像一个`/`更像一种`、`很容易`
...
1. **先通读全文**，凭借对 AI 写作模式的理解，识别所有疑似 AI 化的表述——无论是否出现在清单中
