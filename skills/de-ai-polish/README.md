...
- [reference/personal-style-guide.md](./reference/personal-style-guide.md)：Voice Calibration 流程和默认 voice 规则
- [reference/quality-scoring.md](./reference/quality-scoring.md)：质量评分和 voice profile 门禁
