...
- **Step 7：交付前评分门禁**：把 `reference/quality-scoring.md` 的 5 维评分（自然度 / 节奏感 / 专业度 / 个性度 / 精炼度，总分 10）提升为强制门禁。总分 < 7.0 或单维度硬伤（自然度 < 1.5 / 个性度 = 0）必须回炉 Step 4 重修；法律文书场景下专业度 < 1.5 即回炉。

### 变更

- `reference/quality-scoring.md` 新增"作为交付门禁使用"节：明确何时评、回炉阈值、场景调整；并引入"直接度""信任读者"两个辅助视角（不新增维度，仅作评分检查点）。
