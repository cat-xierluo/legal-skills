...
1. 根据插图描述选择布局模板（flow / layer / matrix / hub / tree / cycle / radar / skill-card / timeline-lane / matrix-grid，或组合模板）
...
12 种布局模板（10 种基础 + 2 种组合），详见 `references/layout-templates.md`。
