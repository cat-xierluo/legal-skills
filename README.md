...
| 日期       | 类型   | Skill                                                                 | 版本    | 更新要点                                                                                                                                                                                                                                       |
| :--------- | :----- | :-------------------------------------------------------------------- | :------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-26 | 更新   | [md2word](skills/md2word/)                                             | v1.3.1  | **引用框与表后节奏修复**：导读/案例改为正文全宽的段落浅灰底，不再用表格容器，因此 Word“查看网格线”不会出现虚线外框；Markdown/HTML 数据表由组件自身追加可配置的 6pt exact 留白，后续正文和图片/图注样式不变 |
