...
| 日期       | 类型   | Skill                                                                 | 版本    | 更新要点                                                                                                                                                                                                                                       |
| :--------- | :----- | :-------------------------------------------------------------------- | :------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-27 | 更新 | [local-asr](skills/local-asr/) | v2.1.1→v2.2.1 | 声纹链路审计整改：注册向量按模型维度/数值校验并隔离坏条目，声纹库原子保存+进程锁+损坏保护；识别结果逐人返回并新增 speaker_states 完整状态；自动 CLI 新增 --json/--save-result 与 claim 认领命令；摘要保留说话人归属并校验漏人/杜撰；截图默认阈值全入口统一为 20；"置信度"更正为"声纹相似度"。 |
...
<td style="text-align:center">MIT</td>
<td style="text-align:center">v2.2.1（源码）</td>
